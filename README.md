...
- **Vercel:** ensure the project root contains `package.json`. If your repo has this app inside a subfolder, set **Root Directory** to that subfolder.
- **ENV vars:** `ATLANTIC_BASE_URL`, `ATLANTIC_API_KEY`, `ATLANTIC_DEFAULT_TYPE`.
